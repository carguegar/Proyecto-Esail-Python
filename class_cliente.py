class Cliente():
    def __init__(self, id_cliente, nombre, apellido1, apellido2, DNI, numero_tarjeta, numero_tlf, correo, fecha_nacimiento):
...
class ticket(Producto, Cliente):
    def __init__(self, id_ticket, id_cliente, id_producto, fecha_compra, cantidad):
    ...
    def id_producto(self, id_producto):
        self.__id_producto = id_producto
    @fecha_compra.setter
    def fecha_compra(self, fecha_compra):
        self.__fecha_compra = fecha_compra
    @cantidad.setter
